...
#define TOTAL_CLASS_COUNT_MNIST 10
#define TOTAL_CLASS_COUNT_COIN 7
#define FEATURE_SIZE_COIN 32040
...
public:
	...
	std::vector<std::vector<double>> coinMat;
...
protected:
	...
	bool shuffleData();
	bool listBinFile(const char* pathName, std::vector<std::string>& binVec);
};
