...
public:
	...
	void loadTrainingParameter(int input_count,
							  int output_count,
	...
	void loadNetwork(std::vector<int>& layer_size,
					 double p_bias,
					 std::string activation_type,
	...
	std::vector<double> getNetWeights() { return this->netWeights; }

protected:
	bool createNetwork();
	void initialize();
	void initializeTrained();
